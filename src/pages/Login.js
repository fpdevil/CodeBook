                ...
                <div className="w-full rounded-lg border shadow-lg sm:max-w-md md:mt-0 xl:p-0 dark:border border-slate-100 dark:bg-slate-800 dark:border-slate-700 hover:shadow-indigo-500/40">
                    <div className="p-6 space-y-4 sm:p-8 md:space-y-6">
                        ...
                        <button
                            ...
                            type="submit"
                            className="py-2.5 px-5 w-full text-sm font-medium text-center text-white bg-blue-700 rounded-lg dark:bg-blue-600 hover:text-yellow-200 hover:bg-indigo-800 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:hover:bg-indigo-700 dark:focus:ring-indigo-200"
                        >
                            LogIn As Guest
                        </button>
